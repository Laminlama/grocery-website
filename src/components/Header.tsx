...
import { HiOutlineClipboardList } from "react-icons/hi"; // New Icon for To-Buy List
    ...
    <>
      <header className="max-w-screen-2xl flex text-center justify-between items-center py-4 px-5 text-black mx-auto max-sm:px-5 max-[400px]:px-3">
        ...
        <div className="flex gap-4 items-center max-sm:gap-2">
          ...
          {/* New To-Buy List Icon */}
          <Link to="/to-buy-list">
            <HiOutlineClipboardList className="text-2xl max-sm:text-xl" />
          </Link>
        </div>
      </header>
      <SidebarMenu
